...
-- AddForeignKey
ALTER TABLE "comments" ADD CONSTRAINT "comments_anwer_id_fkey" FOREIGN KEY ("anwer_id") REFERENCES "answers"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "attachments" ADD CONSTRAINT "attachments_anwer_id_fkey" FOREIGN KEY ("anwer_id") REFERENCES "answers"("id") ON DELETE SET NULL ON UPDATE CASCADE;
